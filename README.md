...
- Cada **3 segundos** hace un ping HTTP a backend y frontend, y un socket check a MongoDB.
...
Para probar que el monitor detecta correctamente las caídas, se pueden detener los servicios de forma individual. El monitor tarda hasta **3 segundos** en reflejar el cambio.
